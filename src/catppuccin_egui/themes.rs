// Vendored from https://github.com/catppuccin/egui (src/themes.rs, generated from
// themes.rs.tera). The upstream crate only supports egui up to 0.33; this copy is
// adapted to egui 0.35 (via `eframe::egui`). See mod.rs for provenance.
//
// The full upstream flavor set is kept intact for fidelity; kvakk only uses MOCHA.
#![allow(dead_code)]
